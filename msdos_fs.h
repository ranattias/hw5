...
#define MSDOS_NAME_8 8	/* maximum name length */
#define MSDOS_EXT	3	/* maximum name length */
...
#define IS_FSINFO(x)	((x)->signature1 == FAT_FSINFO_SIG1 \
			 && (x)->signature2 == FAT_FSINFO_SIG2)
...
struct msdos_dir_entry {
	__u8	name[MSDOS_NAME_8];/* name and extension */
	__u8	ext[MSDOS_EXT];/* name and extension */
